...
#signup("Akul","a.mangal@gmail.com","passwordpp",movies_list)
...
def getrecommendationsbysearch(request):    
    ...
    return render(request, 'recommendation.html',
                  {'movie': name, "year": year, "ImageBG": bg, "poster": poster, "cast": cast_arr, "genre": genre, "plot": plot,
                    "Ratings": rating, "movies1": m1, "trailer": trailer, "watch": watch,"Runtime":runtime})
...
def getrecommendationsbychoice(request):
    ...
    return render(request, 'recommendation.html',
                  {'movie': name, "year": year, "ImageBG": bg, "poster": poster, "cast": cast_arr, "genre": genre, "plot": plot,
                    "Ratings": rating, "movies1": m1, "trailer": trailer, "watch": watch})
